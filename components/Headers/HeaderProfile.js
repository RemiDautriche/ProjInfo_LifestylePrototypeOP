...
export default function HeaderProfile() {
    ...
    return(
        <View>
            ...
            <TouchableOpacity style = {{height: 55, width: 80, position: 'absolute', right: 0, justifyContent: 'center'}}> 
                <Image source={icons.OptionsIcon} style ={{resizeMode: 'stretch', height: 25, width: 22, tintColor: 'white', alignSelf: 'center'}}/>
            </TouchableOpacity>
        </View>
    )
}